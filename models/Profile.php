        ...
        if (count($result) > 0) {
            ...
            if (hash_hmac("sha256", $password, $dbSalt) == $dbHashedPassword) {
                ...
                if ($dbEmailActiavated == 1) {
                    ...
                    return array('Response' => 200, 'Content' => array('userId' => $this->getUserId($userName), 'userName' => $userName, 'userLocation' => $this->getUserLocation($this->getUserIP(), IPSTACK_ACCESSKEY), 'userAvatar' => $avatargit));
                } else {
